        ...
        for epoch in range(1, num_epoch + 1):
            ...
            if epoch in [50, 100, 500, 1000, 10000]:
                ...
                torch.save(self.gnn.state_dict(),
                           "./Experiment/pre_trained_model/{}/{}/{}.{}.{}.pth".format(self.dataset_name, 'Edgepred_GPPT','config_' + str(self.config_name) , self.gnn_type, 'epoch_' + str(epoch)))
                
                self._logger.info("+++model saved !./Experiment/pre_trained_model/{}/{}/{}.{}.{}.pth".format(self.dataset_name, 'Edgepred_GPPT','config_' + str(self.config_name) , self.gnn_type, 'epoch_' + str(epoch)))
